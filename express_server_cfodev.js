...
var directory = "/home/cfodev/workspace/express_server/images"  // express server post
...
api_router.get('/hello', function(req, res){
    ...
    const base_path = '/home/cfodev/workspace/express_server/images/' + "2021041903" + '/'  + '_/'
    console.log("base_path " + base_path)

    if (!fs.existsSync(base_path)){
        fs.mkdirSync(base_path, { recursive: true });
    }
    res.send(JSON.stringify({"base_path":"asdasdasd"}));
});
...
api_router.post('/upload', function(req, res){
    ...
    try {
        ...
        const base_path = '/home/cfodev/workspace/express_server/images/' + time_str + '/' + img_type + '/'
        console.log("base_path " + base_path)
